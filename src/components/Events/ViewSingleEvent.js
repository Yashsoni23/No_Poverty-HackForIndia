...
export default function ViewSingleEvent() {
  ...
  useEffect(() => {
    function getEvent() {
      axios
        .get(`https://no-poverty.adaptable.app/events/get/${id}`)
        .then((res) => {
          if (res.data.status) {
    ...
    <div>
      ...
      <div
        style={{
          ...
          backgroundImage: `url('https://images.unsplash.com/photo-1552664730-d307ca884978?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MXx8d29ya3Nob3AlMjBzZXNzaW9ufGVufDB8fDB8fA%3D%3D&w=1000&q=80')`,
        }}
      >
        <div
          style={{
